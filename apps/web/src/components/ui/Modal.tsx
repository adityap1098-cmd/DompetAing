...
export function Modal({ isOpen, onClose, title, children }: ModalProps) {
  ...
  return (
    <>
      ...
      {/* Bottom sheet — bg #FFF/#1C1D1A, radius 20px top, matches mockup */}
      <div
        role="dialog"
        aria-modal="true"
      ...
      >
        {/* Drag handle — 36px wide, 3px high */}
        <div className="flex justify-center pt-2.5 pb-1 shrink-0">
          <div className="w-9 h-[3px] rounded-full bg-[rgba(0,0,0,0.08)] dark:bg-[rgba(255,255,255,0.1)]" />
        </div>

        {/* Header */}
        <div className="flex items-center justify-between px-[17px] py-3 border-b border-[rgba(0,0,0,0.07)] dark:border-[rgba(255,255,255,0.07)] shrink-0">
          <h2
            id="modal-title"
